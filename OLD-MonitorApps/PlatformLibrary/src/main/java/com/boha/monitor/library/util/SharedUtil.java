...
public class SharedUtil {
    ...
    public static void saveGCMDevice(Context ctx, GcmDeviceDTO dto) {
        ...
        ed.commit();
        Log.e(TAG, "saveGCMDevice:------------------------%%%%% Device saved in SharedPreferences: " + dto.getRegistrationID());
    }
    ...
    public static GcmDeviceDTO getGCMDevice(Context ctx) {
        ...
        if (co != null)
            ...
            Log.e("SharedUtil", "No device in prefs");
        }
        return co;
    }
    ...
    public static void savePhoto(Context ctx, PhotoUploadDTO dto) {
        ...
        if (ctx == null) {
            Log.e(TAG, "savePhoto: Context is null. quit!" );
            return;
        }
